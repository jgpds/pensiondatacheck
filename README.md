...
The goal of pensiondatacheck is to make regular expressions more
...
You can install the development version of pensiondatacheck from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("jennybc/pensiondatacheck")
```
...
That’s exactly what `pensiondatacheck::str_split_one()` does.

``` r
library(pensiondatacheck)
